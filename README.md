...
**Distinct wallets that have interacted with the contract: 7 total — 4 external testers** (narrivex, Mustafa Çolak, Nomet, Vansh Dhiwar — each joined, contributed, and/or created circles via their own wallets; 2 of them also submitted written feedback via the [form](#user-feedback)). Verifiable on [Stellar Expert](https://stellar.expert/explorer/testnet/contract/CACYGZA4BTSU5EZZKFL5XFPS2SBRSRCMXPGIB54Q4LZDVOD4SF2WWSCI) — every create, join, contribution, and payout is public on-chain.
